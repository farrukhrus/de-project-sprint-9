...
import dds_loader.repository.dds_model as model
...
class BUILDER:
    ...
    def h_product(self) -> List[model.H_Product]:
        ...
        for product in products:
            h_products.append(
                model.H_Product(
                    h_product_pk=self.gen_uuid(product["id"]),
    ...
    def h_category(self) -> List[model.H_Category]:
        ...
        for product in products:
            ...
            h_categories.append(
                model.H_Category(
                    h_category_pk=self.gen_uuid(category_name),
    ...
    def h_restaurant(self) -> model.H_Restaurant:
        ...
        return model.H_Restaurant(
            h_restaurant_pk=self.gen_uuid(restaurant_id),
    ...
    def h_order(self) -> model.H_Order:
        ...
        return model.H_Order(
            h_order_pk=self.gen_uuid(order_id),
            order_id=order_id,
            order_dt=order_dt,
            load_dt=datetime.utcnow(),
            load_src=self.source_system,
    ...
    def s_user_names(self) -> model.S_User_Names:
        ...
        return model.S_User_Names(
            ...
            load_dt=datetime.utcnow(),
            load_src=self.source_system,
            hk_user_names_hashdiff=self.gen_uuid(
    ...
    def s_product_names(self) -> List[model.S_Product_Names]:
        ...
        for product in products:
            product_id = product["id"]
            hk_product_pk = self.gen_uuid(product_id)
            ...
            s_product_names.append(
                model.S_Product_Names(
                    ...
                    load_dt=datetime.utcnow(),
                    load_src=self.source_system,
                    hk_product_names_hashdiff=self.gen_uuid(
    ...
    def s_restaurant_names(self) -> model.S_Restaurant_Names:
        ...
        return model.S_Restaurant_Names(
            ...
            load_dt=datetime.utcnow(),
            load_src=self.source_system,
            hk_restaurant_names_hashdiff=self.gen_uuid(
    ...
    def s_order_cost(self) -> model.S_Order_Cost:
        ...
        return model.S_Order_Cost(
            ...
            load_dt=datetime.utcnow(),
            load_src=self.source_system,
            hk_order_cost_hashdiff=self.gen_uuid(
    ...
    def s_order_status(self) -> model.S_Order_Status:
        ...
        return model.S_Order_Status(
            ...
            load_dt=datetime.utcnow(),
            load_src=self.source_system,
            hk_order_status_hashdiff=self.gen_uuid(str(h_order_pk) + str(order_status)),
        )
        ...
        for product in products:
            ...
            l_order_products.append(
                model.L_Order_Product(
                    hk_order_product_pk=self.gen_uuid(str(h_order_pk) + str(h_product_pk)),
                    h_order_pk=h_order_pk,
        ...
        for product in products:
            ...
            l_product_restaurants.append(
                model.L_Product_Restaurant(
                    hk_product_restaurant_pk=self.gen_uuid(
    ...
    def l_product_category(self) -> List[model.L_Product_Category]:
        ...
        for product in products:
            h_product_pk = self.gen_uuid(product["id"])
            h_category_pk = self.gen_uuid(product["category"])
            hk_product_category_pk = self.gen_uuid(str(h_product_pk) + str(h_category_pk))
    ...
    def l_order_user(self) -> model.L_Order_User:
        ...
        return model.L_Order_User(
            hk_order_user_pk=self.gen_uuid(str(h_order_pk) + str(h_user_pk)),
            h_order_pk=h_order_pk,
            h_user_pk=h_user_pk,
            load_dt=datetime.utcnow(),
            load_src=self.source_system,
